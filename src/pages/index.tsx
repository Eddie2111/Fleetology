        ...
        <div className="text-black text-4xl my-5 py-5 pb-10 mb-10">
            ...
            >
                <center>
                    <Lottie
                        animationData={Uber}
                        style={{ height: "60%", width: "60%", marginTop:"-10rem" }}
                        className="rounded-md"
                    />
                    <p className="text-4xl mt-[-5rem] mb-[3rem]"> Making your shipments secure and acknowledged</p>
                    <p className="text-xl mb-[3rem]"> What Fleetology Provides</p>
                </center>
            </motion.div>
